...
When a repository or runtime pin changes, update both executable provenance contracts in the same
reviewed PR so CI can reject planning/documentation drift from the command and ingress surfaces.
